  ...
  return (
    <>
      ...
      <p>
        ...
        einverstanden. Diese Website kann grundsätzlich ohne Registrierung
        ...
        Name, Adresse oder E-Mail-Adresse werden soweit möglich auf freiwilliger
      ...
      <p>
        ...
        EU-DSGVO anwendbar ist – Personendaten gemäss folgenden Rechtsgrundlagen
      ...
      <ul>
        ...
        <li>
          ...
          dem Recht der sozialen Sicherheit und des Sozialschutzes erwachsenden
          Rechte ausüben und seinen bzw. ihren diesbezüglichen Pflichten
          nachkommen kann, erfolgt deren Verarbeitung nach Art. 9 Abs. 2 lit. b.
          DSGVO, im Fall des Schutzes lebenswichtiger Interessen der Bewerber
          oder anderer Personen gem. Art. 9 Abs. 2 lit. c. DSGVO oder für Zwecke
      ...
      <p>
        ...
        Zweck oder die jeweiligen Zwecke erforderlich ist. Bei länger dauernden
      ...
      <p>
        ...
        Erfüllung unserer Leistungen und Durchführung vertraglicher Massnahmen
      ...
      <p>
        ...
        der unterschiedlichen Eintrittswahrscheinlichkeiten und des Ausmasses
        der Bedrohung der Rechte und Freiheiten natürlicher Personen geeignete
        technische und organisatorische Massnahmen, um ein dem Risiko
      ...
      <p>
        ...
        Fall beachten wir die gesetzlichen Vorgaben und schliessen insbesondere
      ...
      <p>
        ...
        gesetzlich erforderlicher Übermittlung, verarbeiten wir die Daten nur in
        Drittländern mit einem anerkannten Datenschutzniveau, vertraglicher
        Verpflichtung durch sogenannte Standardschutzklauseln der EU-Kommission,
        beim Vorliegen von Zertifizierungen oder verbindlichen internen
        Datenschutzvorschriften (Art. 44 bis 49 DSGVO, Informationsseite der
        EU-Kommission:
      ...
      <p>
        ...
        besuchten Websites oder Domains enthalten und von einem Browser auf dem
        Computer des Benutzers gespeichert werden. Ein Cookie dient in erster
        Linie dazu, die Informationen über einen Benutzer während oder nach
      ...
      <ul>
        ...
        <li>
          <strong>Statistik-, Marketing- und Personalisierung-Cookies</strong>:
      ...
      <p>
        ...
        mittels der Einstellungen Ihres Browsers erklären, z.B., indem Sie die
        Nutzung von Cookies deaktivieren (wobei hierdurch auch die
