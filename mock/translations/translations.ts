export const translations: Record<string, string> = {
  ...
  PRODUCT_image: 'Angebot Bild',
  PRODUCT_edit: 'Bearbeiten',
  PRODUCT_delete: 'Löschen',
  PRODUCT_updated_info: 'Der Eintrag wurde gespeichert:',
  PRODUCT_settings: 'Angebotseinstellungen',
  PRODUCT_request_from: 'Anfrage von',
  PRODUCT_description: 'Angebot Beschreibung',
  PRODUCTS_my_list: 'Meine Angebote',
  PRODUCT_location_at: 'in',
  PRODUCT_label: 'Angebot',
  ...
  BUTTON_borrow: 'Angebot in Anspruch nehmen',
  ...
  INVITATION_successful_send: 'Deine Einladung wurde erfolgreich versandt',
