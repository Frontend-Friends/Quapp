export const translationsEn: Record<string, string> = {
  ...
  HOME_together_text:
    'Sharing is caring - in our opinion, every neighborhood should live by this motto! Quapp makes it easy for you to connect with your neighborhood and support each other.',
  ...
  CREATE_PRODUCT_description: 'Product Description',
  ...
  SVG_collaborator:
    'A purely decorative illustration showing people working together',
  SVG_hangout:
    'A purely decorative illustration showing two people drinking coffee together at a table.',
  SVG_windowneighbours:
    'A purely decorative illustration showing two neighbors talking.',
